...
module.exports = {
  ...
  rules: {
    ...
    'no-console':       'off',  // Until logger utility is introduced
    'no-process-env':   'off',  // Until refactoring
    'sort-imports':     'off',  // Until sorting rules that prioritize from clauses are introduced
    ...
    '@typescript-eslint/camelcase': [ 'error', { allow: [ '.*_token', '.*_type', 'expires_in' ]}],  // To allow specified in an external service such as OAuth.

    // Switch rule from ESLint to TypeScript ESLint
